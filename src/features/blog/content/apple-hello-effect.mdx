...
image: https://assets.ramana.devimages/blog/writing-effect-inspired-by-apple.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://ramana-dev.vercel.app/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn add @ramanak/apple-hello-effect
```
...
} from "@/components/ramanak/apple-hello-effect"
```
