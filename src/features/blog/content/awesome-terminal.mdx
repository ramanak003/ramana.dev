...
image: https://assets.ramana.dev/images/blog/awesome-terminal.webp
...
Reference: https://github.com/ramanak003/ramanak.zsh-theme

```bash
git clone git@github.com:ramanak/ramanak.zsh-theme.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/ramanak.zsh-theme
```

**Activate the theme**

```bash title="~/.zshrc"
ZSH_THEME="ramanak.zsh-theme/ramanak"
```
