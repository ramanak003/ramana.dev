...
image: https://assets.ramana.devimages/blog/scroll-fade-effect.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://ramana-dev.vercel.app/r/scroll-fade-effect.json"
/>
...
```bash
npx shadcn add @ramanak/scroll-fade-effect
```
...
<ComponentSource
  ...
  title="components/ramanak/scroll-fade-effect.tsx"
  showLineNumbers
  collapsible={false}
/>
...
```tsx
import { ScrollFadeEffect } from "@/components/ramanak/scroll-fade-effect"
```
