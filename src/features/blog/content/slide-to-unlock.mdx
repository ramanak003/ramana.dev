...
image: https://assets.ramana.devimages/blog/slide-to-unlock.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://ramana-dev.vercel.app/r/slide-to-unlock.json"
  codeCollapsible
...
```bash
npx shadcn add @ramanak/slide-to-unlock
```
...
<ComponentSource
  ...
  title="components/ramanak/slide-to-unlock.tsx"
  showLineNumbers
/>
...
import {
  ...
  SlideToUnlockText,
  SlideToUnlockTrack,
} from "@/components/ramanak/slide-to-unlock"

import { ShimmeringText } from "@/component/ramanak/shimmering-text"
```
