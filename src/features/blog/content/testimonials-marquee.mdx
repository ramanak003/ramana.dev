...
image: https://assets.ramana.devimages/blog/testimonials-marquee.webp?v=2
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://ramana-dev.vercel.app/r/testimonials-marquee.json"
  codeCollapsible
/>
...
```bash
npx shadcn add @ramanak/testimonials-marquee
```
...
<ComponentSource
  ...
  title="components/ramanak/testimonials-marquee.tsx"
  showLineNumbers
/>
...
} from "@/components/ramanak/testimonials-marquee"
```
