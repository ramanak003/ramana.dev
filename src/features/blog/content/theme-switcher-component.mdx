...
image: https://assets.ramana.devimages/blog/theme-switcher-component.webp
category: components
icon: theme-switcher
...
<ComponentPreview
  ...
  openInV0Url="https://ramana-dev.vercel.app/r/theme-switcher.json"
/>
...
```bash
npx shadcn add @ramanak/theme-switcher
```
...
<ComponentSource
  name="theme-switcher"
  title="components/ramanak/theme-switcher.tsx"
  showLineNumbers
/>
...
```tsx
import { ThemeSwitcher } from "@/components/ramanak/theme-switcher"
```
