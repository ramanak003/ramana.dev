...
Licensed under the [MIT license](https://github.com/ramanak/ramana.dev/blob/main/LICENSE).

The source code is available on [GitHub](https://github.com/ramanak/ramana.dev). You're free to use my code! Just make sure to remove all my personal information before publishing your website. It's awesome to see my code being useful to someone!
