...
const WORK_EXPERIENCE: ExperienceItemType[] = [
  {
    ...
    companyLogo: "https://assets.ramana.dev/images/companies/quaric.svg",
    positions: [
      {
...
- Build and maintain Rex Website landing page.
- Develop and maintain the responsive web design features.`,
        skills: [
          "Next.js",
          "Strapi",
          "Auth0",
